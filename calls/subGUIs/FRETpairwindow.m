...
% UI elements for DeepFRET confidence
handles.DeepFRETConfText = uicontrol('Parent',handles.figure1,'Style','text',...
    'String','DeepFRET confidence','HorizontalAlignment','left',...
    'Tag','DeepFRETConfText');
handles.DeepFRETConfidence = uicontrol('Parent',handles.figure1,'Style','text',...
    'String','-','HorizontalAlignment','left','Tag','DeepFRETConfidence');
...
h = [handles.FRETpairsTextbox handles.PairListbox handles.DeletePairPushbutton...
    handles.paircoordinates handles.PairCoordinatesTextbox handles.DeepFRETConfText handles.DeepFRETConfidence...
