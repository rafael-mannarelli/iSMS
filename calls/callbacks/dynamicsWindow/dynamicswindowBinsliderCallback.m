function dynamicswindowBinsliderCallback(hObject,event,dwHandle)
% Callback for the bin slider in the dynamics window
%
%    Input:
%     hObject   - handle to slider
%     event     - not used
%     dwHandle  - handle to dynamics window
%
...
set(dwHandles.BinsTextbox,'String',sprintf('Bins: %i',get(hObject,'Value')))