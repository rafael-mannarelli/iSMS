function rawpanelMenu2Fcn(hObject, event, mainhandle)
% Callback for the ROI panel help button
%
%   Input:
...
if (~isempty(mainhandles.adjustROIswindowHandle)) && (ishandle(mainhandles.adjustROIswindowHandle))
    figure(mainhandles.adjustROIswindowHandle)
    return
end
...
mainhandles.adjustROIswindowHandle = fineadjustROIsWindow;
