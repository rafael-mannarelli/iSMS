function ROIpanelChannelFcn(hObject, event, mainhandle)
% Callback for the ROI panel shift emission channel button
%
%   Input:
...
% Shift emission channel
mainhandles = shiftROIchannelCallback(mainhandles);
