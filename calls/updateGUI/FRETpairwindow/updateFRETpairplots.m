...
if isfield(mainhandles.data(file).FRETpairs(pair),'DeepFRET_probs')
    ...
    set([FRETpairwindowHandles.text28,...
         FRETpairwindowHandles.aggregatedTextBox,...
         FRETpairwindowHandles.dynamicTextBox,...
         FRETpairwindowHandles.noisyTextBox,...
         FRETpairwindowHandles.scrambledTextBox,...
         FRETpairwindowHandles.staticTextBox,...
         FRETpairwindowHandles.confidenceValueTextBox,...
         FRETpairwindowHandles.aggregatedValueTextBox,...
         FRETpairwindowHandles.dynamicValueTextBox,...
         FRETpairwindowHandles.noisyValueTextBox,...
         FRETpairwindowHandles.scrambledValueTextBox,...
         FRETpairwindowHandles.staticValueTextBox],'Visible','on');
    ...
    set([FRETpairwindowHandles.text28,...
         ...
         FRETpairwindowHandles.noisyValueTextBox,...
         FRETpairwindowHandles.scrambledValueTextBox,...
         FRETpairwindowHandles.staticValueTextBox],...
        'Visible','off','String','-');
end
