...
obj = findobj(gcf,'type','UIContextMenu');
try delete(obj), end
...
if ~isempty(getappdata(0,'hInvisibleAxes'))% && ishandle(getappdata(0,'hInvisibleAxes'))
    curPointer = getappdata(0,'curPointer');
    curPointerShapeCData = getappdata(0,'curPointerShapeCData');
    validObjects = getappdata(0,'validObjects');
    curCallbacks = getappdata(0,'curCallbacks');
    allHG = getappdata(0,'allHG');
...
setappdata(0,'curPointer',curPointer)
setappdata(0,'curPointerShapeCData',curPointerShapeCData)
setappdata(0,'validObjects',validObjects)
setappdata(0,'curCallbacks',curCallbacks)
setappdata(0,'allHG',allHG)
