...
%             defaultTitleColor = [0.05 0.25 0.5]; % Toolbox defaults
%             defaultForegroundColor = [1 1 1];
            defaultTitleColor = [0.75 0.9 1.0];
            defaultForegroundColor = [0 0 0];
            ...
            % CUSTOMS
            % Tooltip strings
            tooltipStringMenu = getappdata(0,'tooltipMenuString'); % Tool tip string
            if isempty(tooltipStringMenu)
                tooltipStringMenu = 'Settings for this panel';
            end
            tooltipStringMenu2 = getappdata(0,'tooltipMenu2String'); % Tool tip string
            if isempty(tooltipStringMenu2)
                tooltipStringMenu2 = 'Advanced settings for this panel';
            end
            tooltipStringMenu3 = getappdata(0,'tooltipMenu3String'); % Tool tip string
            if isempty(tooltipStringMenu3)
                tooltipStringMenu3 = 'Advanced settings 3';
            end
            tooltipStringSave = getappdata(0,'saveMenuString'); % Tool tip string
            if isempty(tooltipStringSave)
                tooltipStringSave = 'Save';
            end
            tooltipStringROIchannel = getappdata(0,'tooltipROIchannelString'); % Tool tip string
            if isempty(tooltipStringROIchannel)
                tooltipStringROIchannel = 'Shift emission channel';
            end
            tooltipStringRun = getappdata(0,'tooltipRunString'); % Tool tip string
            if isempty(tooltipStringRun)
                tooltipStringRun = 'Run';
            end
            
            MenuButton = matlab.ui.control.UIControl( ...
                'Internal', true, 'Parent', obj, 'Style', 'checkbox', ...
                'CData', cData.Menu, 'Visible', 'off', ...
                'BackgroundColor', defaultTitleColor, ...
                'TooltipString', tooltipStringMenu );
            Menu2Button = matlab.ui.control.UIControl( ...
                'Internal', true, 'Parent', obj, 'Style', 'checkbox', ...
                'CData', cData.Menu2, 'Visible', 'off', ...
                'BackgroundColor', defaultTitleColor, ...
                'TooltipString', tooltipStringMenu2 );
            Menu3Button = matlab.ui.control.UIControl( ...
                'Internal', true, 'Parent', obj, 'Style', 'checkbox', ...
                'CData', cData.Menu3, 'Visible', 'off', ...
                'BackgroundColor', defaultTitleColor, ...
                'TooltipString', tooltipStringMenu3 );
            SaveButton = matlab.ui.control.UIControl( ...
                'Internal', true, 'Parent', obj, 'Style', 'checkbox', ...
                'CData', cData.Save, 'Visible', 'off', ...
                'BackgroundColor', defaultTitleColor, ...
                'TooltipString', tooltipStringSave );
            ROIchannelButton = matlab.ui.control.UIControl( ...
                'Internal', true, 'Parent', obj, 'Style', 'checkbox', ...
                'CData', cData.ROIchannel, 'Visible', 'off', ...
                'BackgroundColor', defaultTitleColor, ...
                'TooltipString', tooltipStringROIchannel );
            RunButton = matlab.ui.control.UIControl( ...
                'Internal', true, 'Parent', obj, 'Style', 'checkbox', ...
                'CData', cData.Run, 'Visible', 'off', ...
                'BackgroundColor', defaultTitleColor, ...
                'TooltipString', tooltipStringRun );
            ...
            % CUSTOMS
            obj.MenuButton = MenuButton;
            obj.Menu2Button = Menu2Button;
            obj.Menu3Button = Menu3Button;
            obj.SaveButton = SaveButton;
            obj.ROIchannelButton = ROIchannelButton;
            obj.RunButton = RunButton;
    ...
    methods
        ...
        function set.TitleColor( obj, value )
            ...
            % CUSTOMS
            obj.MenuButton.BackgroundColor = value;
            obj.Menu2Button.BackgroundColor = value;
            obj.Menu3Button.BackgroundColor = value;
            obj.SaveButton.BackgroundColor = value;
            obj.ROIchannelButton.BackgroundColor = value;
            obj.RunButton.BackgroundColor = value;
        ...
        function value = get.Menu2Fcn( obj )
            ...
            value = obj.Menu2Button.Callback;
        ...
        function set.Menu2Fcn( obj, value )
            ...
            % Set
            obj.Menu2Button.Callback = value;
        ...
        function value = get.Menu3Fcn( obj )
            ...
            value = obj.Menu3Button.Callback;
        ...
        function set.Menu3Fcn( obj, value )
            ...
            % Set
            obj.Menu3Button.Callback = value;
        ...
        function value = get.ROIchannelFcn( obj )
            ...
            value = obj.ROIchannelButton.Callback;
            
        end % get.ROIchannelFcn
        
        function set.ROIchannelFcn( obj, value )
            
            % Set
            obj.ROIchannelButton.Callback = value;
            
            % Redraw buttons
            obj.redrawButtons()
            
        end % set.ROIchannelFcn

        function value = get.RunFcn( obj )
            
            value = obj.RunButton.Callback;
    ...
    methods( Access = private )
        ...
        function redrawButtons( obj )
            ...
            % CUSTOMS
            menuButtonEnabled = ~isempty( obj.MenuFcn );
            if menuButtonEnabled
                menuPosition = [x y w h];
                x = x - w - s;
            end
            menu2ButtonEnabled = ~isempty( obj.Menu2Fcn );
            if menu2ButtonEnabled
                menu2Position = [x y w h];
                x = x - w - s;
            end
            menu3ButtonEnabled = ~isempty( obj.Menu3Fcn );
            if menu3ButtonEnabled
                menu3Position = [x y w h];
                x = x - w - s;
            end
            saveButtonEnabled = ~isempty( obj.SaveFcn );
            if saveButtonEnabled
                savePosition = [x y w h];
                x = x - w - s;
            end
            ROIchannelButtonEnabled = ~isempty( obj.ROIchannelFcn );
            if ROIchannelButtonEnabled
                ROIchannelPosition = [x y w h];
                x = x - w - s;
            end
            runButtonEnabled = ~isempty( obj.RunFcn );
            if runButtonEnabled
                runPosition = [x y w h];
                x = x - w - s;
            end
            ...
            % CUSTOMS
            if menuButtonEnabled
                obj.MenuButton.Position = menuPosition;
                obj.MenuButton.Visible = 'on';
            else
                obj.MenuButton.Visible = 'off';
            end
            if menu2ButtonEnabled
                obj.Menu2Button.Position = menu2Position;
                obj.Menu2Button.Visible = 'on';
            else
                obj.Menu2Button.Visible = 'off';
            end
            if menu3ButtonEnabled
                obj.Menu3Button.Position = menu3Position;
                obj.Menu3Button.Visible = 'on';
            else
                obj.Menu3Button.Visible = 'off';
            end
            if saveButtonEnabled
                obj.SaveButton.Position = savePosition;
                obj.SaveButton.Visible = 'on';
            else
                obj.SaveButton.Visible = 'off';
            end
            if ROIchannelButtonEnabled
                obj.ROIchannelButton.Position = ROIchannelPosition;
                obj.ROIchannelButton.Visible = 'on';
            else
                obj.ROIchannelButton.Visible = 'off';
            end
            if runButtonEnabled
                obj.RunButton.Position = runPosition;
                obj.RunButton.Visible = 'on';
            else
                obj.RunButton.Visible = 'off';
            end
        end % redrawButtons
...
%             obj.HelpButton.CData = obj.ColorButtonCData.Help;
    ...
    methods( Access = private, Static )
        ...
        function cData = getButtonCData()
            ...
            cData.Close = uix.loadIcon( [icondir 'panelClose.png'] );
            cData.Dock = uix.loadIcon( [icondir 'panelDock.png'] );
            cData.Undock = uix.loadIcon( [icondir 'panelUndock.png'] );
            cData.Help = uix.loadIcon( [icondir 'panelHelp.png'] );
            cData.Minimize = uix.loadIcon( [icondir 'panelMinimize.png'] );
            cData.Maximize = uix.loadIcon( [icondir 'panelMaximize.png'] );
            
            % CUSTOMS
            cData.Menu = uix.loadIcon( [icondir 'panelMenu2.png'] );
            cData.Menu2 = uix.loadIcon( [icondir 'panelMenu3.png'] );
            cData.Menu3 = uix.loadIcon( [icondir 'panelMenu2.png'] );
            cData.Save = uix.loadIcon( [icondir 'saveIcon.png'] );
            cData.ROIchannel = uix.loadIcon( [icondir 'ROIchannel.png'] );
            cData.Run = uix.loadIcon( [icondir 'panelRun.png'] );
        end % getButtonCData
